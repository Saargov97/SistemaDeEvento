...
import com.example.easycheckin.data.LoginRepository
...
class LoginViewModel @ViewModelInject constructor (private val loginRepository: UserRepository) : ViewModel() {
